...
CREATE TABLE `reference_analyses` (
    ...
    INDEX `reference_analyses_tenant_ref_created_idx`(`tenant_id`, `reference_content_id`, `created_at`),
    INDEX `reference_analyses_tenant_id_status_idx`(`tenant_id`, `status`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `generation_jobs` (
    ...
    INDEX `generation_jobs_tenant_id_status_queued_at_idx`(`tenant_id`, `status`, `queued_at`),
    INDEX `generation_jobs_tenant_id_cat_asset_id_idx`(`tenant_id`, `cat_asset_id`),
    UNIQUE INDEX `generation_jobs_tenant_id_topic_candidate_id_job_version_key`(`tenant_id`, `topic_candidate_id`, `job_version`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `content_packages` (
    ...
    `schema_version` VARCHAR(64) NOT NULL,
    `title_options_json` JSON NOT NULL,
    `body` TEXT NOT NULL,
    `short_caption` TEXT NOT NULL,
    `fact_references_json` JSON NOT NULL,
    `image_concept` TEXT NOT NULL,
    `image_prompt` TEXT NOT NULL,
    `image_status` VARCHAR(32) NOT NULL,
    `image_asset_key` VARCHAR(512) NULL,
    ...
    UNIQUE INDEX `content_packages_generation_job_id_key`(`generation_job_id`),
    INDEX `content_packages_tenant_id_generation_job_id_idx`(`tenant_id`, `generation_job_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- CreateTable
CREATE TABLE `generation_model_calls` (
    `id` VARCHAR(36) NOT NULL,
    `tenant_id` VARCHAR(64) NOT NULL DEFAULT 'bangcat',
    `generation_job_id` VARCHAR(36) NOT NULL,
    ...
    INDEX `generation_model_calls_tenant_job_created_idx`(`tenant_id`, `generation_job_id`, `created_at`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `content_reviews` (
    ...
    INDEX `content_reviews_tenant_id_generation_job_id_created_at_idx`(`tenant_id`, `generation_job_id`, `created_at`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `reference_analyses` ADD CONSTRAINT `reference_analyses_reference_content_id_fkey` FOREIGN KEY (`reference_content_id`) REFERENCES `reference_contents`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `generation_jobs` ADD CONSTRAINT `generation_jobs_topic_candidate_id_fkey` FOREIGN KEY (`topic_candidate_id`) REFERENCES `topic_candidates`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `generation_jobs` ADD CONSTRAINT `generation_jobs_cat_asset_id_fkey` FOREIGN KEY (`cat_asset_id`) REFERENCES `cat_assets`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `content_packages` ADD CONSTRAINT `content_packages_generation_job_id_fkey` FOREIGN KEY (`generation_job_id`) REFERENCES `generation_jobs`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `generation_model_calls` ADD CONSTRAINT `generation_model_calls_generation_job_id_fkey` FOREIGN KEY (`generation_job_id`) REFERENCES `generation_jobs`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `content_reviews` ADD CONSTRAINT `content_reviews_generation_job_id_fkey` FOREIGN KEY (`generation_job_id`) REFERENCES `generation_jobs`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
